    ...
    while True:
        ...
        if output:
            ...
            if "authorized" in str(output.strip()).lower():
                ...
                subprocess.Popen(["aplay", "{}/alexa-rpi/audio-files/AlexaStartup.wav".format(USER_PATH)], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
                #Comment the line below if you want to create your own indicator pattern
            ...
            if "alexa state: listening" in str(output.strip().lower()):
                ...
                subprocess.Popen(["aplay", "{}/alexa-rpi/audio-files/AlexaTriggered.wav".format(USER_PATH)], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
                #Comment the line below if you want to create your own indicator pattern
...
run_command("{}/alexa-rpi/scripts/startsampleassistant.sh".format(USER_PATH))
